...
Naskah: ${scriptInput}`;
    ...
    } catch (e) { addToast('Gagal menganalisis naskah', 'error'); } 
  ...
  const handleAutoDescribe = async (assetData) => {
    ...
    } catch (e) { addToast('Gagal auto-describe', 'error'); } 
...
`;
    ...
    } catch (err) { addToast('Gagal merangkai prompt. Periksa API Key.', 'error'); } 
  ...
  // Memasukkan parameter Shot dari Naskah ke Builder
